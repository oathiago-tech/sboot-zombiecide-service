...
@Entity
@Table (name = "match_player_items", schema = "zombicide", uniqueConstraints = {@UniqueConstraint (name = "ux_mpi_unique_item_per_player", columnNames = {"match_player_id", "item_id"})})
@Getter
@Setter
